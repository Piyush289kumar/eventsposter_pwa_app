            ...
            <div class="col-lg-10 mx-auto">
                <div class="card shadow-sm">
                    <div class="card-body p-5">
                        <h1 class="mb-4 text-dark">Privacy Policy</h1>
                        <p class="text-muted"><small>Last updated: June 09, 2025</small></p>
                        ...
                        <div class="mb-5">
                            <h2 class="border-bottom pb-2 mb-3">Interpretation and Definitions</h2>
                            ...
                            <div class="mb-4">
                                ...
                                <ul class="list-group list-group-flush mb-3">
                                    ...
                                    <li class="list-group-item">
                                        <p><strong>Application</strong> refers to Khyati Digi Ad, the software program provided by the Company.</p>
                                    </li>
                                    <li class="list-group-item">
                                    ...
                                    <li class="list-group-item">
                                        <p><strong>Website</strong> refers to Khyati Digi Ad, accessible from <a href="https://khyatidigital.com/"
                                                rel="external nofollow noopener" target="_blank" class="text-decoration-none">https://khyatidigital.com/</a></p>
                                    </li>
                                    <li class="list-group-item">
                        ...
                        <div class="mb-5">
                            <h2 class="border-bottom pb-2 mb-3">Collecting and Using Your Personal Data</h2>
                            
                            <div class="mb-4">
                                <h3 class="h4">Types of Data Collected</h3>
                                
                                <div class="mb-3">
                                    <h4 class="h5">Personal Data</h4>
                                ...
                                <div class="mb-3">
                                    <h4 class="h5">Tracking Technologies and Cookies</h4>
                                    ...
                                    <ul class="list-group list-group-flush mb-3">
                                        <li class="list-group-item"><strong>Cookies or Browser Cookies.</strong> A cookie is a small file placed on Your Device. You can
                                        ...
                                        <li class="list-group-item"><strong>Web Beacons.</strong> Certain sections of our Service and our emails may contain small electronic
                                    ...
                                    <p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal
                                        ...
                                        browser. You can learn more about cookies on <a href="https://www.termsfeed.com/blog/cookies/#What_Are_Cookies"
                                            target="_blank" class="text-decoration-none">TermsFeed website</a> article.</p>
                            ...
                            <div class="mb-4">
                                <h3 class="h4">Use of Your Personal Data</h3>
                                ...
                                <ul class="list-group list-group-flush mb-3">
                                    <li class="list-group-item"><strong>With Service Providers:</strong> We may share Your personal information with Service Providers to
                                        monitor and analyze the use of our Service, to contact You.</li>
                                    <li class="list-group-item"><strong>For business transfers:</strong> We may share or transfer Your personal information in connection
                                    ...
                                    <li class="list-group-item"><strong>With Affiliates:</strong> We may share Your information with Our affiliates, in which case we will
                                        ...
                                        with Us.</li>
                                    <li class="list-group-item"><strong>With business partners:</strong> We may share Your information with Our business partners to offer
                                        You certain products, services or promotions.</li>
                                    <li class="list-group-item"><strong>With other users:</strong> when You share personal information or otherwise interact in the public
                                        areas with other users, such information may be viewed by all users and may be publicly distributed outside.
                                    </li>
                                    <li class="list-group-item"><strong>With Your consent</strong>: We may disclose Your personal information for any other purpose with
                                        Your consent.</li>
                                </ul>
                            </div>
                            
                            <div class="mb-4">
                                <h3 class="h4">Retention of Your Personal Data</h3>
                            ...
                            <div class="mb-4">
                                <h3 class="h4">Transfer of Your Personal Data</h3>
                            ...
                            <div class="mb-4">
                                <h3 class="h4">Delete Your Personal Data</h3>
                            ...
                            <div class="mb-4">
                                <h3 class="h4">Disclosure of Your Personal Data</h3>
                                
                                <div class="mb-3">
                                    <h4 class="h5">Business Transactions</h4>
                                ...
                                <div class="mb-3">
                                    <h4 class="h5">Law enforcement</h4>
                                ...
                                <div class="mb-3">
                                    <h4 class="h5">Other legal requirements</h4>
                            ...
                            <div class="mb-4">
                                <h3 class="h4">Security of Your Personal Data</h3>
                        ...
                        <div class="mb-5">
                            <h2 class="border-bottom pb-2 mb-3">Children's Privacy</h2>
                        ...
                        <div class="mb-5">
                            <h2 class="border-bottom pb-2 mb-3">Links to Other Websites</h2>
                        ...
                        <div class="mb-5">
                            <h2 class="border-bottom pb-2 mb-3">Changes to this Privacy Policy</h2>
                        ...
                        <div class="mb-4">
                            <h2 class="border-bottom pb-2 mb-3">Contact Us</h2>
                            <p>If you have any questions about this Privacy Policy, You can contact us:</p>
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">By email: <a href="mailto:khyatidigiad@gmail.com" class="text-decoration-none">khyatidigiad@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
